...
void Server::setupSocket() {
    ...
    // Make socket non-blocking (required by subject)
...
void Server::processClientCommand(Client* client, const std::string& command) {
    // Basic command parsing - we'll expand this
    std::cout << "Client " << client->getFd() << " sent: " << command << std::endl;
    
    // TODO: Implement IRC command parsing
    // For now, just echo back
    client->sendMessage("Echo: " + command);
}
